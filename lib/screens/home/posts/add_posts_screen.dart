                    ...
                    children: [
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    AppCubit.get(context)
                                                            .imageFileList
                                                            .isEmpty
                                                        ? lang == 'ar' ? 'اضف صورة' : "Add Image"
                                                        : lang == 'ar' ? 'عدد الصور' : "Image No.",
                                                    style: TextStyle(
                                                      fontFamily: lang == 'ar' ? 'arabic2' : 'poppins',
                                                      fontWeight:
                                                          FontWeight.w500,
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          if (value!.isEmpty) {
                            return 
                            lang == 'ar' ? 'لا يمكنك نشر منشور فارغ' : 'Post body must not be empty';
                          }
                          return null;
                        },
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: lang == 'ar' ? 'ماذا يدور في ذهنك؟' : 'What\'s on your mind?',
                          hintStyle: TextStyle(
                            fontFamily: lang == 'ar' ? 'arabic2' : 'poppins',
                            fontSize: fontSizeReduced ? 18 : 23,
                            color: Colors.grey,
